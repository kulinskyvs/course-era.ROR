...
class LineAnalyzer
  ...
  def calculate_word_frequency
    ...
    @highest_wf_words = word_frequency.select { |key, value| @highest_wf_count == value}.keys
...
class Solution
  ...
  def calculate_line_with_highest_frequency
    ...
    @highest_count_words_across_lines = @analyzers.
      select {|analyzer| @highest_count_across_lines == analyzer.highest_wf_count}
  end

  #Implement the print_highest_word_frequency_across_lines() method to
  #* print the values of objects in highest_count_words_across_lines in the specified format
  def print_highest_word_frequency_across_lines
    formatted_lines = @highest_count_words_across_lines.join "\n"
